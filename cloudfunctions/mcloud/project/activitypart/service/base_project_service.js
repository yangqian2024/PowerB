...
class BaseProjectService extends BaseService {
	...
	async initSetup() {
		...
		let F = (c) => 'bx_' + c;
		const INSTALL_CL = 'setup_activitypart';
		...
		const NEWS_CATE = '1=公告通知,2=社区风采';
		const ACTIVITY_CATE = '1=志愿者活动,2=文化活动,3=艺术活动,4=体育活动,5=公益活动,6=其他';
		const PRODUCT_CATE = '1=党群园地,2=文史学习,3=社区规章,4=安全常识';
